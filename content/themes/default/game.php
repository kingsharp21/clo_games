...
<script type="text/javascript">
    ...
    function count_time() {
        nIntervId = setInterval(incrementSeconds, 1000);
    }

    function destroy_time() {
        var xsec = seconds;
    ...
    function showdetails() {
        ...
        /*let params = 'value=200&gameid='+gameid;
        let xhr = new XMLHttpRequest();
        xhr.open('POST', url+'/includes/time_score_api.php', true);
        ...
        $.ajax({
            type: "POST",
            url: url+'/includes/time_score_api.php',
            data: {gameid:gameid, value:xxval},
            dataType: 'JSON'
        }).done(function() {
            console.log( "ok" );
        }).fail(function() {
		...
		<div class="row">
			<div class="col-md-9 game-content">
				<div class="game-iframe-container">
					<iframe class="game-iframe" id="game-area" src="<?php echo get_game_url($game); ?>" width="<?php echo esc_int($game->width); ?>" height="<?php echo esc_int($game->height); ?>" scrolling="none" frameborder="0" allowfullscreen
                            onmouseover="count_time();" onmouseout="showdetails();"></iframe>
				</div>
