...
<p>If you got any issues after updating. You may already modify internal code (Internal changes can break the update).</p>
<p>You can go back to previous version. Each update attept, system will create a backup file (Games and thumbnail files are not backed up).</p>
