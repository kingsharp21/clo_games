...
class Game
{
	...
	public static function getList($amount = 1000, $sort = 'id DESC', $page = 0)
	{
		$conn = open_connection();
	...
	public function insert()
	{
		...
		$conn = open_connection();
		$sql = 'INSERT INTO games ( createdDate, title, description, instructions, category, source, thumb_1, thumb_2, thumb_small, url, width, height, tags, slug, views, upvote, downvote ) 
	...
	public function update()
	{
		...
		//
		$conn = open_connection();
		$sql = "UPDATE games SET title=:title, slug=:slug, description=:description, instructions=:instructions, category=:category, thumb_1=:thumb_1, thumb_2=:thumb_2, thumb_small=:thumb_small, url=:url, width=:width, height=:height, fields=:fields WHERE id = :id";
