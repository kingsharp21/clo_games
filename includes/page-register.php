				...
				<div class="container">
					...
					<form action="" method="POST">
						...
						<div class="form-group">
							...
							<input type="password" id="password" name="password" autocomplete="new-password" placeholder="<?php _e('Password') ?>" class="form-control" value="" type="password" minlength="6" required>
						</div>
						<div class="form-group">
							<label><?php _e('Re-type password') ?></label>
							<input type="password" id="password" name="confirm_password" placeholder="<?php _e('Password') ?>" class="form-control" value="" type="password" minlength="6" required>
						</div>
